  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r1.xyzw = max(gauss_minUV.xyxy, v2.xyzw);
  r1.xyzw = min(gauss_maxUV.xyxy, r1.xyzw);
  r2.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.zw, 0).xyz;
  r0.xyz = r2.xyz * gauss_weights[2].xyz + r0.xyz;
  r0.xyz = r1.xyz * gauss_weights[3].xyz + r0.xyz;
  r1.xyzw = max(gauss_minUV.xyxy, v3.xyzw);
  r1.xyzw = min(gauss_maxUV.xyxy, r1.xyzw);
  r2.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.zw, 0).xyz;
  r0.xyz = r2.xyz * gauss_weights[4].xyz + r0.xyz;
  r0.xyz = r1.xyz * gauss_weights[5].xyz + r0.xyz;
  r1.xyzw = max(gauss_minUV.xyxy, v4.xyzw);
  r1.xyzw = min(gauss_maxUV.xyxy, r1.xyzw);
  r2.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.zw, 0).xyz;
  r0.xyz = r2.xyz * gauss_weights[6].xyz + r0.xyz;
  r0.xyz = r1.xyz * gauss_weights[7].xyz + r0.xyz;
  r1.xy = max(gauss_minUV.xy, v5.xy);
