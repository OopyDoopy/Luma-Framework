  ...
  out float4 o0 : SV_TARGET0)
{
  ...
  r0.xy = gauss_offsets[2].xy + v1.xy;
  r0.xy = max(gauss_minUV.xy, r0.xy);
  r0.xy = min(gauss_maxUV.xy, r0.xy);
  r0.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r0.xy, 0).xyz;
  r0.xyz = gauss_weights[1].xyz * r0.xyz;
  r1.xy = gauss_offsets[0].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[0].xyz + r0.xyz;
  r1.xy = gauss_offsets[4].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[2].xyz + r0.xyz;
  r1.xy = gauss_offsets[6].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[3].xyz + r0.xyz;
  r1.xy = gauss_offsets[8].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[4].xyz + r0.xyz;
  r1.xy = gauss_offsets[10].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[5].xyz + r0.xyz;
  r1.xy = gauss_offsets[12].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[6].xyz + r0.xyz;
  r1.xy = gauss_offsets[14].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[7].xyz + r0.xyz;
  r1.xy = gauss_offsets[16].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[8].xyz + r0.xyz;
  r1.xy = gauss_offsets[18].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[9].xyz + r0.xyz;
  r1.xy = gauss_offsets[20].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[10].xyz + r0.xyz;
  r1.xy = gauss_offsets[22].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[11].xyz + r0.xyz;
  r1.xy = gauss_offsets[24].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[12].xyz + r0.xyz;
  r1.xy = gauss_offsets[26].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[13].xyz + r0.xyz;
  r1.xy = gauss_offsets[28].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[14].xyz + r0.xyz;
  r1.xy = gauss_offsets[30].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[15].xyz + r0.xyz;
  r1.xy = gauss_offsets[32].xy + v1.xy;
  r1.xy = max(gauss_minUV.xy, r1.xy);
  r1.xy = min(gauss_maxUV.xy, r1.xy);
  r1.xyz = srcSamplerTexture.SampleLevel(srcSampler_s, r1.xy, 0).xyz;
  r0.xyz = r1.xyz * gauss_weights[16].xyz + r0.xyz;
