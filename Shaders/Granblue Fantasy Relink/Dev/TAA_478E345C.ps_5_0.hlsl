// ---- Created with 3Dmigoto v1.4.1 on Thu Feb 12 12:40:38 2026
...
SamplerState LinearClamp_s : register(s3);
Texture2D<float4> g_ColorTexture : register(t3);
Texture2D<float4> g_OldColorTexture : register(t4);
Texture2D<float4> g_ZTexture : register(t5);
Texture2D<float4> g_PrevZTexture : register(t6);
Texture2D<float4> g_GeometryBuffer03 : register(t23);
  ...
  out float4 o1 : SV_Target1)
{
  ...
  r0.xyzw = g_ZTexture.Gather(LinearClamp_s, v1.xy, int2(-1, -1)).xyzw;
  r1.xz = g_ZTexture.Gather(LinearClamp_s, v1.xy, int2(0, -1)).zy;
  r2.xy = g_ZTexture.Gather(LinearClamp_s, v1.xy, int2(-1, 0)).xy;
  r3.xyzw = g_ZTexture.Gather(LinearClamp_s, v1.xy).xyzw;
  r1.w = cmp(1 >= r0.w);
  if (r1.w != 0) {
    r4.x = r0.w;
  } else {
  ...
  r0.xy = (int2)r0.xy;
  r0.zw = float2(0,0);
  r0.xy = g_GeometryBuffer03.Load(r0.xyz).xy;
  r0.zw = v1.xy + -r0.xy;
  r1.xy = (int2)v0.xy;
  r1.xyz = g_ColorTexture.Load(r1.xyz).xyz;
  r2.xy = float2(1,1) / g_TargetUvParam.zw;
  r2.zw = r0.zw * g_TargetUvParam.zw + float2(-0.5,-0.5);
  r2.zw = floor(r2.zw);
  r4.xyzw = float4(0.5,0.5,-0.5,-0.5) + r2.zwzw;
  r5.xy = r0.zw * g_TargetUvParam.zw + -r4.xy;
  r5.zw = r5.xy * r5.xy;
  r6.xy = r5.xy * r5.zw;
  r6.zw = r5.wz + r5.wz;
  ...
  r4.xy = r6.xy + r4.xy;
  r6.xy = r4.xy * r2.xy;
  r8.xyz = g_OldColorTexture.Sample(LinearClamp_s, r6.xy).xyz;
  r6.zw = r4.zw * r2.xy;
  r2.zw = float2(2.5,2.5) + r2.zw;
  r2.xy = r2.xy * r2.zw;
  r4.xyz = g_OldColorTexture.Sample(LinearClamp_s, r6.xw).xyz;
  r7.xy = r5.wz * r7.xy;
  r4.w = 1;
  r9.xyz = g_OldColorTexture.Sample(LinearClamp_s, r6.zy).xyz;
  r9.w = 1;
  ...
  r2.zw = r6.yx;
  r6.xyz = g_OldColorTexture.Sample(LinearClamp_s, r2.xz).xyz;
  r2.xz = r5.xy * r5.zw;
  r6.w = 1;
  r4.xyzw = r6.xyzw * r2.xxxx + r4.xyzw;
  r5.xyz = g_OldColorTexture.Sample(LinearClamp_s, r2.wy).xyz;
  r5.w = 1;
  ...
  r2.xyz = g_ColorTexture.Sample(LinearClamp_s, v1.xy, int2(0, 0)).xyz;
  ...
  r6.xyz = g_ColorTexture.Sample(LinearClamp_s, v1.xy, int2(0, 0)).xyz;
  ...
  r2.xyzw = g_PrevZTexture.Gather(LinearClamp_s, r0.zw).xyzw;
