// ---- Created with 3Dmigoto v1.4.1 on Thu Feb 12 14:21:21 2026
...
RWTexture2D<unorm4> OutputTexture : register(u0);
...
// unknown dcl_: dcl_thread_group 16, 16, 1
  ...
  r1.xy = vThreadID.xy;
  r1.zw = float2(0,0);
  r2.xyz = SrcTexture.Load(r1.xyw).xyz;
  r3.x = DepthTexture.Load(r1.xyw).x;
  r3.x = g_Proj._m22 + r3.x;
  r3.x = g_Proj._m32 / r3.x;
